...
function PANEL:Expand() 
	...
	self:AddSeparator()
	self:AddControl("toggle_channels","button","OC",Vector(0.7,0.4,0.8),function() console.Call("debug_toggle pp_channels") end,true)
	self:AddControl("toggle_light","button","OC",Vector(0.7,0.4,0.8),function() console.Call("debug_toggle light") end,true) 
	self:AddControl("fix_exposure","button","FE",Vector(0.7,0.4,0.8),function() console.Call("r_exposure 1") end) 
