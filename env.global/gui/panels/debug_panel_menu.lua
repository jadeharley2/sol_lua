...
function PANEL:Expand() 
	...
	self:AddSeparator()
	self:AddControl("editor","button","WE",Vector(0.8,0.8,0),function() editor.Toggle() end)
	self:AddControl("editor_lua","button","LE",Vector(0.2,0.8,0.2),function() console.Call("ed_lua") end)
	self:AddSeparator()
