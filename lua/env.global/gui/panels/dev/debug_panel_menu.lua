...
function PANEL:Expand() 
	...
	self:AddControl("form_browser","button","FB",Vector(0.2,0.9,0.8),function() 
		if abstract_filepanel then abstract_filepanel:Close() abstract_filepanel = false 
		else abstract_filepanel = panel.Create('window_dforms') abstract_filepanel:Show() 
		end 
	end)
	...
	self:AddControl("toggle_bones","button","BO",Vector(0.9,0.9,0.9),function() console.Call("debug_toggle bones") end,true)
